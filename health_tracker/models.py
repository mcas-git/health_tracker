...
class DailyEntry(Base):
    ...
    evening_submitted: Mapped[bool] = mapped_column(Boolean, default=False)
...
class AppPreferences(Base):
    ...
    muted_color: Mapped[str | None] = mapped_column(String(20))
    link_color: Mapped[str | None] = mapped_column(String(20))
    border_color: Mapped[str | None] = mapped_column(String(20))
